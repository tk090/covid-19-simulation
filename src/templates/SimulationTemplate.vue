  ...
  <div>
    <div class="text-white  my-12 m-auto" style="max-width: 1128px;">
      ...
      <div class="mt-6 text-sm flex items-center">
        ...
        visuelles Simulationsprogramm, mit dem die Ausbreitungsdynamik von Covid-19 und anderen Krankheiten spielerisch
        erforscht werden kann.
      </div>
      <div class="mt-2 text-sm flex items-center">
        <i class="mdi mdi-source-pull text-xl mr-2"></i>
        Dieses Projekt ist OpenSource, Pull-Requests und Forks sind erwünscht
      </div>
    </div>
